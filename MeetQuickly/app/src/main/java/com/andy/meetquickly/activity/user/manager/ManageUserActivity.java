...
public class ManageUserActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        adapter = new MyFraiendSimpleAdapter(mContext,mData,4);
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                UserDataActivity.start(ManageUserActivity.this,mData.get(position).getuId());
            }
        });
    ...
    private void showSureDialog(int position) {
        ...
        SelectDialog.show(ManageUserActivity.this, "提示", "解除绑定后，该用户将不会在你的网店 “可能邂逅的人”中出现", "确定", new DialogInterface.OnClickListener() {
            @Override
    ...
    private void cancleFollow(int position) {
        showWaitDialog(ManageUserActivity.this);
...
//                        JSON.parseObject(s,new MyApiResult<String>().getClass());
    ...
    public void initData() {
        showWaitDialog(ManageUserActivity.this);
        MQApi.getMyUsersList(userBean.getUId(), new SimpleCallBack<String>() {
            @Override
            public void onError(ApiException e) {
                dissmissWaitDialog();
                RxToast.showToast(e.toString());
...
//                        JSON.parseObject(s, new TypeReference<MyApiResult<List<UserFriendBean>>>() {});
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, ManageUserActivity.class);
