...
import static com.andy.meetquickly.common.Constant.API_SERVER;

/**
 * @Author: created by Andy
 * @CreateDate: 2019/4/24 19:26
 * 描述：
 */
...
//        params.put("appId", AppConstant.APPID);
        ...
        EasyHttp.getInstance()
                ...
                //可以全局统一设置全局URL
                .setBaseUrl(API_SERVER)//设置全局URL  url只能是域名 或者域名+端口号

                // 打开该调试开关并设置TAG,不需要就不要加入该行
                // 最后的true表示是否打印内部异常，一般打开方便调试错误
                .debug("meet_quickly", true)

                //如果使用默认的60秒,以下三行也不需要设置
                .setReadTimeOut(120 * 1000)
                .setWriteTimeOut(120 * 100)
                .setConnectTimeout(120 * 100)
