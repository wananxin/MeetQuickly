...
public class UserCardMessage extends MessageContent {
    ...
    public UserCardMessage(byte[] data) {
//        super(data);
//        String jsonStr=null;
//        try {
...
//        }
    ...
    public static final Creator<UserCardMessage> CREATOR = new Creator<UserCardMessage>() {
        @Override
        public UserCardMessage createFromParcel(Parcel source) {
            return new UserCardMessage(source);
        }
        @Override
        public UserCardMessage[] newArray(int size) {
            return new UserCardMessage[size];
        }
    };
