 ...
 */
public class ManageOrderCancelFragment extends BaseLazyFragment {
    ...
    public ManageOrderCancelFragment() {
    ...
    private void initData() {
        MQApi.getUserOrderInfo(userBean.getUId(), 2, 4, mPage, new SimpleCallBack<String>() {
            @Override
...
//                        JSON.parseObject(s, new TypeReference<MyApiResult<List<OrderDetailBean>>>(){});
    ...
    private void initView() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ManageOrderCancelFragment.this.getContext()));
        adapter = new ManageOrderAdapter(mData, ManageOrderCancelFragment.this.getContext(), 3);
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ManageOrderDetailActivity.start(ManageOrderCancelFragment.this.getContext(), mData.get(position));
            }
        });
    ...
    private void showSureDeleteDialog(int position) {
        SelectDialog.show(ManageOrderCancelFragment.this.getContext(), "提示", "是否确认删除订单？", "确定", new DialogInterface.OnClickListener() {
            @Override
    ...
    private void deleteOrder(int position) {
        showWaitDialog(ManageOrderCancelFragment.this.getActivity());
