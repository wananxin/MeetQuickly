 ...
 */
public class CouponUseAdapter extends BaseQuickAdapter<CouponBean,BaseViewHolder> {

    public CouponUseAdapter(@Nullable List<CouponBean> data) {
        super(R.layout.item_coupon_use, data);
    }
