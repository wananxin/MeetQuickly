 ...
 * 描述：
 */
public class UserGridImageAdapter extends
        RecyclerView.Adapter<UserGridImageAdapter.ViewHolder> {
    public static final int TYPE_CAMERA = 1;
    public static final int TYPE_PICTURE = 2;
    private LayoutInflater mInflater;
    private List<UserMediaBean> list = new ArrayList<>();
    ...
    public UserGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener , onDelPicClickListener mOnDelPicClickListener) {
    ...
    public void setList(List<UserMediaBean> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            UserMediaBean media = list.get(position);
            String path = "";
            path = media.getUrl();
