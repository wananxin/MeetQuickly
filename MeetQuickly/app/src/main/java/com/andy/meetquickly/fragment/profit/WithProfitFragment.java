 ...
 * Use the {@link WithProfitFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WithProfitFragment extends BaseLazyFragment {
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if (view.getId() == R.id.tv_button) {
                    RongIM.getInstance().startPrivateChat(WithProfitFragment.this.getContext(), mData.get(position).getUid(), mData.get(position).getNickName());
                }
            }
        });
    ...
    private void initData() {
        MQApi.getTotalIncomeDetailList(userBean.getUId(), mPage, mParam == 1 ? 2 : 1, new SimpleCallBack<String>() {
            @Override
...
//                        JSON.parseObject(s, new TypeReference<MyApiResult<List<WithProfitBean>>>(){});
                if (myApiResult.isOk()) {
                    ...
                    if (mData.size() == 0) {
                        ...
                        if (mParam == 1) {
                            textView.setText("昨日收益：" + mData.get(0).getCommissionCount());
                        } else {
                            textView.setText("合伙人总收益：" + mData.get(0).getCommissionCount());
                        }
                    }
    ...
    public static WithProfitFragment newInstance(int param) {
        WithProfitFragment fragment = new WithProfitFragment();
