 ...
 */
public class UserVisitPeopleAdapter extends BaseQuickAdapter<UserBaseBean.UserVisitBean,BaseViewHolder> {

    private Context context;
    public UserVisitPeopleAdapter(@Nullable List<UserBaseBean.UserVisitBean> data , Context context) {
        super(R.layout.item_round_head, data);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, UserBaseBean.UserVisitBean item) {
